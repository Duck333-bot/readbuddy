...
export function ReaderContent({ articleRef, pageNumber, pageCount, paragraphs, nextParagraphs, continuousMode, annotations, chapter, fontSize, lineHeight, textClassName, isLoading }: ReaderContentProps) {
  const style = { fontSize: `${fontSize}px`, lineHeight };
  return (
    <div ref={articleRef} className="pb-4">
