...
![ReadBuddy visual language: richer controlled palette, Memory Terrain art, four graphic primitives, and narrative motion.](assets/color-art-minimalism-reset/visual-language.webp)
...
![ReadBuddy Margin Marks: original icon direction for Explain, Simpler, Context, Who, Lost, Evidence, Memory, Book Brain, Spoilers, and Notebook.](assets/color-art-minimalism-reset/margin-marks.webp)
...
![Desktop landing storyboard: memory hero, spoiler boundary, and evidence-to-return scene.](assets/color-art-minimalism-reset/landing-desktop.webp)

### Mobile

![Mobile landing storyboard: memory hero, spoiler boundary, and evidence-to-return scene.](assets/color-art-minimalism-reset/landing-mobile.webp)
...
| Desktop | Mobile |
|---|---|
| ![Desktop library: personal intellectual collection with page shards and progress threads.](assets/color-art-minimalism-reset/library-desktop.webp) | ![Mobile library: compact personal reading collection with progress threads.](assets/color-art-minimalism-reset/library-mobile.webp) |
...
| Desktop | Mobile |
|---|---|
| ![Desktop upload: a book becoming known through Pages, People, Ideas, and Connections.](assets/color-art-minimalism-reset/upload-desktop.webp) | ![Mobile upload: a book becoming known while reading can begin.](assets/color-art-minimalism-reset/upload-mobile.webp) |
...
| Desktop | Mobile |
|---|---|
| ![Desktop reader: quiet typography with one restrained evidence thread in the margin.](assets/color-art-minimalism-reset/reader-desktop.webp) | ![Mobile reader: calm reading with a compact page-shard evidence moment.](assets/color-art-minimalism-reset/reader-mobile.webp) |
